...
//
//    public LoginPage(Pane root, Stage theStage, Scene adminScene) {
...
//                // If login is successful, switch to the admin page
//                System.out.println("Login successful! Redirecting to Admin Page...");
//                theStage.setScene(adminScene); // Switch to AdminPage
//            } else {
...
//    private Label messageLabel = new Label();
//
//    // Constructor takes the Pane, Stage, and AdminScene
//    public LoginPage(Pane root, Stage theStage, Scene adminScene) {
//        // Set up the UI components
//        setupLabelUI(usernameLabel, "Arial", 14, 100, Pos.CENTER_LEFT, 50, 50);
//        setupTextFieldUI(usernameField, "Arial", 14, 200, Pos.CENTER_LEFT, 160, 50);
...
//    private Label messageLabel = new Label();
//
//    // Constructor that takes the Pane, Stage, and AdminScene to switch pages
//    public LoginPage(Pane root, Stage theStage, Scene adminScene) {
//        // Set up the UI components
//        setupLabelUI(usernameLabel, "Arial", 14, 100, Pos.CENTER_LEFT, 50, 50);
//        setupTextFieldUI(usernameField, "Arial", 14, 200, Pos.CENTER_LEFT, 160, 50);
...
//
//            if (!username.isEmpty() && !password.isEmpty()) {
//                // Print the entered username and password
//                System.out.println("Entered Username: " + username);
//                System.out.println("Entered Password: " + password);
//
//                // Switch to the AdminPage
//                System.out.println("Login successful! Redirecting to Admin Page...");
//                theStage.setScene(adminScene);
//            } else {
//                // Show an error message
//                messageLabel.setText("Please enter both username and password.");
//                messageLabel.setStyle("-fx-text-fill: red;");
...
//    private Label messageLabel = new Label();
//
//    private boolean afterRegistration;  // Flag to check if login is after registration
//
//    // Constructor that takes the Pane, Stage, AdminScene, and CompleteProfileScene
//    public LoginPage(Pane root, Stage theStage, Scene adminScene, Scene completeProfileScene, boolean afterRegistration) {
//        this.afterRegistration = afterRegistration;  // Set the flag to determine where to redirect
//
//        // Set up the UI components
//        setupLabelUI(usernameLabel, "Arial", 14, 100, Pos.CENTER_LEFT, 50, 50);
//        setupTextFieldUI(usernameField, "Arial", 14, 200, Pos.CENTER_LEFT, 160, 50);
...
//                System.out.println("Entered Password: " + password);
//
//                // Redirect based on whether login is after registration
//                if (afterRegistration) {
//                    System.out.println("Login successful! Redirecting to Complete Profile Page...");
//                    theStage.setScene(completeProfileScene); // Switch to CompleteProfilePage
//                } else {
//                    System.out.println("Login successful! Redirecting to Admin Page...");
//                    theStage.setScene(adminScene); // Switch to AdminPage
//                }
