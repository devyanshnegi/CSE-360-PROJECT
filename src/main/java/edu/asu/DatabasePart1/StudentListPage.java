...
public class StudentListPage {
    ...
    public StudentListPage(Pane rootPane, SceneController sceneController) {
        ...
        try {
            ...
            List<String[]> users = databaseHelper.getAllStudents();

            if(users.size()==0) {
            	Label usernameLabel = new Label("No Students");
            }
