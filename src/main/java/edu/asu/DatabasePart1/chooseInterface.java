...
public chooseInterface(Pane Root) {
	// Label theScene with the name of the testbed, centered at the top of the pane
			setupLabelUI(Title, "Arial", 24, chooseOrRegisterPage.WINDOW_WIDTH, 
					Pos.CENTER, 0, 10);
			...
			setupLabelUI(Invite, "Arial", 14, chooseOrRegisterPage.WINDOW_WIDTH-10, 
					Pos.BASELINE_LEFT, 10, 70);
			...
			setupTextUI(Invite_Code, "Arial", 18, chooseOrRegisterPage.WINDOW_WIDTH-20,
			...
			setupLabelUI(noCode, "Arial", 16, chooseOrRegisterPage.WINDOW_WIDTH-10, 
			...
			setupLabelUI(loginOption, "Arial", 14, chooseOrRegisterPage.WINDOW_WIDTH-10, 
			...
			Root.getChildren().addAll(Title, Invite, Invite_Code, noCode, InviteCodeEnter, 
					loginOption, loginRedirect);
}
